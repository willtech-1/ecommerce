...
const Footer = () => {
  return (
    <footer className="dark:bg-gray-900 relative top-28 bg-gray-200">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://google.com/" className="flex items-center">
              <div className="rounded-xl shrink-0">
                <Image className="w-46" src={logo} alt="profile picture" />
              </div>
            </a>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <div className="flex justify-center relative top-2 right-4">
